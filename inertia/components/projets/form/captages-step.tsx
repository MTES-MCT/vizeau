...
export type InstallationsStepProps = {
  data: ProjetFormData
  setData: React.Dispatch<React.SetStateAction<ProjetFormData>>
}

export default function InstallationsStep({ data, setData }: InstallationsStepProps) {
  const page = usePage<InferPageProps<ProjetsController, 'create'>>()
